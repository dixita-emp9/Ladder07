  ...
  return (
    <div>
      ...
      {/* <section className="main_banner">
		<div className="container">
			<div className="banner_shape">
				<img src="./assets/image/global_shape.png" className="banner_left_shape" />
				<img src="./assets/image/global_shape.png" className="banner_right_shape" />
			</div>
			<div className="banner_content">
				<h3 className="sub_title">Finances has never been this interesting.</h3>
				<h1 className="h1_title">Engage With a New Generation</h1>
				<div className="banner_btn_wp">
					<a href="#" className="sec_btn" title="Read More">Read More <img
							src="./assets/image/right_arrow.svg" /></a>
				</div>
			</div>
		</div>
	</section> */}
						...
						<div className="work_tab_box_content">
							<div>
								<div className="work_tab_box_img">
									<img src="./assets/image/work_img.jpg" alt="Life Planning" />
								</div>
								<div className="work_tab_box_text">
									...
									<ul>
										<li>
											<img src="./assets/image/right_arrow.svg" alt="Arrow" width="16"
												height="16" />
		...
		<div className="compliance_wp">
			<div className="compliance_box">
				<div className="compliance_box_icon">
					<img src="./assets/image/black_right_arrow.svg" alt="Compliance Icon" />
				</div>
				<div className="compliance_box_content">
					<img src="./assets/image/complaints_img.png" alt="complaints" />
					...
					<div className="swiper-slide">
						<div className="home_clients_box">
							<div className="home_clients_box_img">
								<img src="./assets/image/work_img.jpg" alt="Client" />
							</div>
	...
	<section className="our_number_sec">
		<div className="container">
				...
				<div className="swiper-wrapper">
					<div className="swiper-slide">
						<div className="our_number_slide number_slide_active">
							<img src="./assets/image/money_img.svg" alt="Number" />
	...
	<section className="clarity_sec">
		<div className="container">
			<div className="clarity_box">
				<img src="./assets/image/clarity_shape.svg" alt="Clarity" className="clarity_shape" />
				<div className="clarity_box_content">
					...
					<a href="#" className="sec_btn" title="Learn More">Learn More <img
							src="./assets/image/right_arrow.svg" /></a>
				</div>
				<div className="clarity_slider_wp">
					<div className="clarity_slider_col clarity_slider_1">
						<div className="swiper-wrapper">
							<div className="swiper-slide">
								<div className="clarity_slider_img">
									<img src="./assets/image/people_1.jpg" alt="people_1" />
								</div>
							</div>
							<div className="swiper-slide">
								<div className="clarity_slider_img">
		...
		<div className="container">
			<div className="meet_sec_main">
				<div className="meet_member">
					<img src="./assets/image/member_1.png" alt="Meet Member 1" className="member_img" />

					<a className="meet_member_play_btn" href="https://vimeo.com/259411563" data-fancybox><img
							src="./assets/image/play_icon.svg" /></a>

					<div className="member_info">
						<a href="#" className="h4_title">Meet <img src="./assets/image/right_arrow.svg" /></a>
	...
	<section className="testimonials_sec">
		<div className="testimonials_shape">
			<img src="./assets/image/global_shape.png" className="testimonials_left_shape" />
			<img src="./assets/image/global_shape.png" className="testimonials_right_shape" />
		</div>
		<div className="container">
			...
			<div className="swiper testimonials_slider">
					...
					<div className="swiper-slide">
						<div className="testimonials_slide">
							<div className="testimonials_img">
								<img src="./assets/image/tesimonials_1.png" alt="People 1" />
							</div>
							<div className="testimonials_content">
								<div className="testimonials_author_info">
									<p>Mr. Alon Musk</p>
				...
				<div className="swiper_button">
					<button className="swiper-button-prev">
						<img src="./assets/image/black_right_arrow.svg" />
					</button>
	...
	<section className="card_sec">
		<div className="container">
			<div className="card_box_wp">
						...
						<div>
							<div className="card_top_content">
								...
								<div className="card_top_content_right">
									<div className="swiper card_top_content_right_slider">
										<div className="swiper-wrapper">
											<div className="swiper-slide">
												<img src="./assets/image/card_slider_1.png" alt="Card Slider 1" />
											</div>
											<div className="swiper-slide">
												<img src="./assets/image/card_slider_2.png" alt="Card Slider 2" />
											</div>

											<div className="swiper-slide">
												<img src="./assets/image/card_slider_3.png" alt="Card Slider 3" />
											</div>
											<div className="swiper-slide">
												<img src="./assets/image/card_slider_1.png" alt="Card Slider 1" />
											</div>
							...
							<div className="card_bottom_content">
								<div className="card_bottom_content_left">
									<div className="card_bottom_content_left_img">
										<img src="./assets/image/blog_img_1.png" alt="Blog Image 1" />
									</div>
								...
								<div className="card_bottom_content_right">
									...
									<a href="#" className="sec_btn" title="Read">Read <img
											src="./assets/image/right_arrow.svg" /></a>
								</div>
							</div>
						</div>
				...
				<div className="card_box active_card_box">
					<div className="card_title">
	...
	{/* <section className="management_sec">
		<div className="container">
			...
			<form className="contact_form">
				...
				<div className="form_input_wp form_element">
					<select className="form_input">
						<option value="When Would you are planning to retire ?" selected>When Would you are planning to
							retire ?
						</option>
				...
				<div className="form_input_wp form_element">
					<select className="form_input">
						<option value="When Would you are planning to retire ?" selected>Total Investable Assets
				...
				<div className="checkbox_input_wp">
					...
					<label for="trem">By clicking the above button, you agree to our Terms of Service and confirm that
				...
				<div className="form_submit">
					<button className="sec_btn" type="button">
						Submit
						<img src="./assets/image/right_arrow.svg" />
					</button>
				</div>
			</form>
		</div>
		<div className="management_bg">
			<img src="./assets/image/management_bg.jpg" alt="management">
		</div>
	</section> */}
			...
			<div className="cta_sec_wp">
				<div className="cta_left_content">
					...
					<a href="#" className="sec_btn">
						Schedule Now <img src="./assets/image/right_arrow.svg" />
					</a>
				</div>

				<div className="cta_right_content">
					<img src="./assets/image/cta_img.png" alt="cta img"/>
				</div>
			</div>
		</div>
	</section>
